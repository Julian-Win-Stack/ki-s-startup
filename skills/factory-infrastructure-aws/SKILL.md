...
Keep infrastructure investigations AWS-first. If the prompt is ambiguous and AWS context is mounted, assume AWS and move forward instead of branching into GCP or Azure.
